...
// Define types for the Avatar props
interface AvatarProps {
  children?: React.ReactNode | string;
  color?: string;
  type?: 'filled' | 'outlined' | 'combined';  // Add type property
  size?: 'badge' | 'xs' | 'sm' | 'md' | 'lg' | 'xl';  // Adjust possible values for size
  alt?: string;  // Alt text for the avatar image
  src?: string;  // Source URL for the avatar image
  others?: any;  // Allow for any other props passed to the component
}
...
const AvatarStyle = styled(MuiAvatar, { shouldForwardProp: (prop: any) => prop !== 'color' && prop !== 'type' && prop !== 'size' })(
...
Avatar.propTypes = {
  ...
  type: PropTypes.oneOf(['filled', 'outlined', 'combined']),
  size: PropTypes.oneOf(['badge', 'xs', 'sm', 'md', 'lg', 'xl']),
  alt: PropTypes.string,  // Add alt prop validation
  src: PropTypes.string,  // Add src prop validation
  sx: PropTypes.object,
